...
def start() :
    ...
    a = a.strftime('%Y-%m-%d')
    b = datetime.now()-timedelta(days=0)
    b = b.strftime('%Y-%m-%d')
    print(b, a)
...
def crawling02() :
    ...
    print("scout 00 :", batch_cnt, while_code, driver, url2)
...
#     while True :
#         print("정체구간 감지 중...")
#         pyautogui.click(x=92, y=52)
#         url1 = driver.current_url
#         time.sleep(1)
#         url2 = driver.current_url
#         if url1 == url2 :
#             print("정체구간 발생 - 새로고침합니다.")
#             pyautogui.click(x=92, y=52)
...
if __name__ == "__main__" :
    ...
    p1 = Process(target=click_every_5s)    
    p2 = Process(target=crawling02)
